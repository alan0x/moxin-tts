...
//! Based on MoYoYo.tts card design.
//!
//! Usage
//!
//! ```rust,ignore
//! use mofa_widgets::card::*;
//!
//! live_design! {
//!     use mofa_widgets::card::*;
//!
...
live_design! {
    ...
    // Base Card component with MoYoYo.tts styling
    pub Card = <View> {
        ...
        draw_bg: {
            ...
            fn pixel(self) -> vec4 {
                ...
                let bg = mix((MOYOYO_BG_SECONDARY), (MOYOYO_BG_SECONDARY_DARK), self.dark_mode);
